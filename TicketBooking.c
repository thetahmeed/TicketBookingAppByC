...

{
...

    {
        ...
        printf("\n\t\tRow 1 to 4: %d taka", b.r1);

        printf("\n\t\tRow 5 to 8: %d taka", b.r2);

        printf("\n\t\tRow 9 to 12: %d taka", b.r3);

        printf("\n\t\tBalcony: %d taka", b.balcony);
...

{
    ...
    seats:
        ...
        printf("\nSelect rows:\n1.Row 1 to 4: %d taka per seat (%d seats available)\n2.Row 5 to 8: %d taka per seat (%d seats available)\n3.Row 9 to 12: %d taka per seat (%d seats available)\n4.Balcony: %d taka per seat (%d seats available)\n", b.r1, s1, b.r2, s2, b.r3, s3, b.balcony, s4);
...

{
...

    {
        ...
        printf("Enter Ticket Price for row 1 to 4 (taka):- ");

        scanf("%d", &b.r1);

        printf("Enter Ticket Price for row 5 to 8 (taka):- ");

        scanf("%d", &b.r2);

        printf("Enter Ticket Price for row 9 to 12 (taka):- ");

        scanf("%d", &b.r3);

        printf("Enter Ticket Price for balcony (taka):- ");
